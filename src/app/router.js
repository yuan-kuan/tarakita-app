...
import { goToHomePage, goToQuestion, goToComment, goToResult } from 'app/home';
...
const setResultUrl = (id) => setUrl(resultPath, { id: encodeURIComponent(id) });
...
function start() {
  ...
  page(resultPath, (ctx) => {
    addSop(() => goToResult(ctx.params.id));
  });
